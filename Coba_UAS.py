...
nol.set_index('tahun',inplace=True)
nol_x=nol.loc[[thn]]
...
neg_min_n=min_n['negara'].to_string(index=False,header=False)
subreg_min_n=min_n['sub-region'].to_string(index=False,header=False)
reg_min_n=min_n['region'].to_string(index=False,header=False)
kode_min_n=min_n['kode_negara'].to_string(index=False,header=False)
prod_min_n=min_n['produksi'].to_string(index=False,header=False)
for i in min_n.index:
    thn_min=i
st.markdown(f"**Negara dengan produksi minyak tahunan terkecil (tak nol) adalah **  {neg_min_n} ({kode_min_n}), Region {reg_min_n}, Sub-region {subreg_min_n}, dengan jumlah produksi {prod_min_n} pada **tahun {thn_min}**\n")
...
st.markdown(f"**Negara dengan produksi minyak terkecil (tak nol) pada tahun {thn} adalah **  {neg_min} ({kode_min}), Region {reg_min}, Sub-region {subreg_min}, dengan jumlah produksi {prod_min} \n")
...
st.markdown(f"**Negara dengan produksi kumulatif minyak terbesar adalah **  {neg_max_kum} ({kode_max_kum}), Region {reg_max_kum}, Sub-region {subreg_max_kum}, dengan jumlah produksi kumulatif {prod_max_kum} \n")
...
st.markdown(f"**Negara dengan produksi kumulatif minyak terkecil (tak nol) adalah **  {neg_min_kum} ({kode_min_kum}), Region {reg_min_kum}, Sub-region {subreg_min_kum}, dengan jumlah produksi kumulatif {prod_min_kum} \n")
